...
* RCS Id: $Id: luathread.h 1881 2006-02-13 01:39:05Z wanghw $
\*======================================================================*/
#ifndef LUATHREAD_H
#define LUATHREAD_H
...
#define lua_lock(L)	      if(lt_mutex(L)) pthread_mutex_lock(lt_mutex(L))
#define lua_unlock(L)     if(lt_mutex(L)) pthread_mutex_unlock(lt_mutex(L))
