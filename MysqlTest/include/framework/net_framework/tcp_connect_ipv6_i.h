...
*	@note:	
*/
class DLL_EXPORT tcpConnectIPv6I : public eventHandlerI
{
public:
	tcpConnectIPv6I();
	virtual ~tcpConnectIPv6I();
...
private:
	...
	socketCbI		*m_connectCb;								//回调类指针
	void			*m_connectCbArg;							//回调类参数类型

	TCPIPV6_CONNECT_STATUS	m_status;					//IPV6的连接状态
